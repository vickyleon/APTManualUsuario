...
\newcommand{\Titulo}{Manual de usuario: administrador}
...
\subsection{Diseño}
	\input{workEnvironment/administrador/design}

\subsection{Iconografía}
	\input{workEnvironment/iconography}
\subsection{Organización}
	\input{menus/menuAdministrador}

\subsection{Componentes Utilizados}
	\input{workEnvironment/components}
	

\input{PRATS/00_pantallaPrincipal}

\input{PRATS/01_indiceAdministrador}
